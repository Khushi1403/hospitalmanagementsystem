...
while (True):
    ...
    mysql = mysql.connector.connect(host="localhost", user="root", passwd="Khushi@1403")
    ...
    mycursor.execute(
        "create table if not exists patient_details(name varchar(30) not null,sex varchar(20),age int(3),address varchar(50),contactno varchar(30))")
    mycursor.execute(
    ...
    while (True):
        ...
        if r == 2:
            ...
            mysql.commit() # IT ENDS THE CURRENT TRANSITION AND NEW ONE STARTS;
        ...
        # IF USER WANTS TO LOGIN
            ...
            row = mycursor.fetchall() # it returns a list of tuples
            for i in row:
                a = list(i)
                if a[0] == str(ps):
                    while (True):
                        ...
                        # entering the patient details table
                            ...
                            # adding new patient
                                ...
                                mycursor.execute(
                                    "insert into patient_details values('" + str(name) + "','" + str(sex) + "','" + str(age) + "','" + str(address) + "','" + str(contact) + " ')")
                                mysql.commit()
                                mycursor.execute("select * from patient_details")
                                for i in mycursor:
                                    v = list(i)
